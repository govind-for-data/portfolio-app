...
def show():
    ...
    col = st.columns([1,1.5,1.5],vertical_alignment= "center")
    with col[0]:
        st.image("assets/1756729896853.jpg", width="stretch")
    with col[1]:
        ...
        #with st.expander("📄 View report"):
            st.markdown(pdf_display, unsafe_allow_html=True, width="stretch")
    with col[2]:
